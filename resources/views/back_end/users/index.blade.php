              ...
              <div class="card">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 text-left">
                      <a href="{{ route('users.create') }}" class="btn btn-white btn-round"><i class="fas fa-user-plus"></i>اضافة</a>
                  </div>
                </div>
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="td-actions text-left">
                              <a href="{{ route('users.edit' , ['id' => $user]) }}" rel="tooltip" title="" class="btn-customized-2" data-original-title="Edit">
